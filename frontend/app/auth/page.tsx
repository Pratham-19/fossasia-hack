...
export default function Page() {
  ...
  return (
    <div className="h-[calc(100vh-20vh)] mx-auto w-fit flex flex-col items-center gap-10 pt-[5%]">
      <Image
        src="/merchant.png"
        className="absolute lg:inset-x-[15%] lg:inset-y-[25%] inset-x-[25%] inset-y-[25%] md:w-[400px] md:h-[400px] w-[600px] h-[600px] "
        alt="GHO"
        width={400}
        height={400}
      />
      <div>
        <Tabs defaultValue={"name"} value={activeTab} className="w-[25vw]">
          <TabsList className="w-full justify-start my-2">
            <TabsTrigger
              value="name"
              ...
              <div className="pt-2 pb-6 px-4 bg-bg-2-60 bg-white bg-opacity-10 backdrop-blur-md drop-shadow-lg relative rounded-xl">
                <TabsContent value="name" className="">
                  ...
                  <p className="text-sm py-2 font-light">
                    A domain is a name for your wallet.
                  </p>
                  <br />
                  ...
                  <div className="flex">
                    <FormField
                      ...
                      name="name"
                      render={({ field }) => (
                        <FormItem className="flex w-full items-center border-none h-fit">
                          <FormControl>
                            <Input
                              type="name"
                              placeholder="Name"
                              {...field}
                              className="rounded-r-none border-none bg-bg-2 text-theme-200 placeholder:text-theme-200 h-9 w-full"
                            />
                          </FormControl>
                          <FormDescription />
                        </FormItem>
                    ...
                    />
                    <span className="rounded-r-md bg-light-grad h-9 py-2 px-4 text-bg-1">
                      .ghoat
                    </span>
                  </div>
                  {/* already taken */}
                ...
                <TabsContent value="authenticate" className="">
                  <h2 className="text-xl font-semibold">Authenticate Domain</h2>
                  <p className="text-sm py-4 font-light">
                    Your bio-metric passkey will grant you access to your brand
                    new Smart Wallet.
                  </p>
      ...
      {activeTab === "authenticate" ? (
        ...
        <div className="flex justify-between items-center gap-24 p-1.5 border-theme-400 border px-3 bg-bg-2-60 bg-white bg-opacity-10 backdrop-blur-md font-thin drop-shadow-lg relative rounded-full">
          ...
          <Button
            ...
            className="rounded-3xl bg-theme-300 hover:bg-theme-300 text-bg-1 font-medium px-5 py-1.5"
          >
            Sign In
            <Loader
              className={`self-end animate-spin ease-in-out ml-2 ${isLoading ? "" : "hidden"}`}
